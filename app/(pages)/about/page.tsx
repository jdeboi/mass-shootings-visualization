...
export default function About() {
    return (
        <div className="h-">
            ...
            <p>While the approach I took has drawbacks (aesthetically, it&apos;s too long for the page, and many of the incidents bars are very narrow), I wonder if this direction might be worth considering if clarity is a primary objective.</p>
        </div>
    )
}
